...
var CONFIG = {
  ...
  MOVE_SPEED: 70.2,      // pixels per frame left and right
  JUMP_POWER: 99.99,     // how hard the jump pushes UP. bigger = higher
  GRAVITY: 0.1,       // how hard the world pulls DOWN. bigger = heavier
